    ...
    <div class="container">
      ...
      >
        ...
        <div v-if="userData" class="text-end">
          <span class="nav-link" href="">Hi, {{ userData ? userData.data.fullName : '' }}</span>
          <ul class="nav">
            <li>
              <span class="me-2 nav-link p-0">Manage Profile</span>
              <ul class="sub-nav position-absolute">
                <li>
                  <RouterLink class="me-2 nav-link p-0" to="#">View Profile</RouterLink>
                </li>
              </ul>
            </li>
            <li>
              <button class="nav-link me-2 p-0" @click="delCookie('User Data')">Sign Out</button>
            </li>
          </ul>
        </div>
